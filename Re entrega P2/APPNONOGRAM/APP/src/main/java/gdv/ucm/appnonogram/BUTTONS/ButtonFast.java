...
import gdv.ucm.appnonogram.SCENES.SelectLvlScene;

public class ButtonFast implements InterfaceA {
    ...
    public ButtonFast(String filename, EngineA engine, int x, int y, int w, int h ){
        this.engine = engine;
