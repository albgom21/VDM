...
public class ButtonReward implements InterfaceA {
    ...
    public ButtonReward(String filename, EngineA engine, int x, int y, int w, int h ){
        this.engine = engine;
    ...
    public boolean handleEvent(InputA.Event e) {
        ...
        if(e.type == InputA.InputTouchType.NORMAL_PRESSED && //click
            ...
            this.engine.getAdManager().showReward();       //muestra el rewarded ad
            return true;
        }
        return false;
    }
