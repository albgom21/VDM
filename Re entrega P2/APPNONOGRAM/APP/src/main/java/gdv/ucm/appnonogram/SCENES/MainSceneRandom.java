...
import gdv.ucm.appnonogram.BUTTONS.ButtonCheck;
import gdv.ucm.appnonogram.BUTTONS.ButtonReward;
import gdv.ucm.appnonogram.BUTTONS.ButtonSurrender;
import gdv.ucm.appnonogram.LOGIC.Board;
import gdv.ucm.appnonogram.LOGIC.Hints;
import gdv.ucm.appnonogram.RENDER.RenderBoard;
import gdv.ucm.appnonogram.RENDER.RenderHints;
...
public class MainSceneRandom implements StateA {
    ...
    public void update(double deltaTime) {
        ...
        {
            this.bCheck.setPos(this.gr.getWidthLogic()-50,this.gr.getHeightLogic()-50);
            this.bSurrender.setPos(50,this.gr.getHeightLogic()-50);
            this.bReward.setPos(50,this.gr.getBorderTop());
        }
        else
        {
    ...
    public void render(GraphicsA graphics) {
        ...
        if(this.board.getLives() < 3) // Si hay menos de 3 vidas se renderiza el boton
            ...
            if(engine.getContext().getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE)
                graphics.drawImage(this.bRewardLock, 50, this.gr.getBorderTop(), 200 / 2, 75 / 2);
            else
