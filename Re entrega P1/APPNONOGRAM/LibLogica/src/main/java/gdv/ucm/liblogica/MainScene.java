...
public class MainScene implements IState {
    ...
    public MainScene(IEngine engine, int cols, int fils) { //ESCENA DE JUEGO
        ...
        this.board = new Board(cols, fils, gr.getBorderTop());
        ...
        this.bCheck = new ButtonCheck("comprobar.png", this.engine, this.hints, (gr.getWidthLogic()/5)*4,(gr.getHeightLogic()/6)*5,200/2,75/2);
        this.bSurrender = new ButtonSurrender("rendirse.png", this.engine, (gr.getWidthLogic()/5),(gr.getHeightLogic()/6)*5,200/2,75/2);
    }
