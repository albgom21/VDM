...
//      CREACION DEL MOTO
        this.engine = new EngineA(this.renderView, this, adRequest, this.filenameStats);
        ...
        // Comenzar en la pantalla de titulo o en un partido
    ...
    protected void onPause() {
        ...
        if(this.engine.getSaveBoard()){ // GUARDAR TABLERO
            if(this.engine.getRandomBoard()){
                ...
                this.engine.serialize(r.getBoard(), filenameBoard);
            }
            else{
