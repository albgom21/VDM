...
public class ButtonLore implements IInterface {
    ...
    ButtonLore(String filename, IEngine engine, int x, int y, int w, int h ){
        this.engine = engine;
    ...
    public boolean handleEvent(IInput.Event e) {
        ...
        if(e.type == IInput.InputTouchType.PRESSED && //click
            ...
            MainSceneRead scene = new MainSceneRead(engine,"filename.txt");
